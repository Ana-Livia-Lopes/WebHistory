...
$glossario = [
    ...
    'colonialismo' => [
        ...
        'image' => 'https://g3i5r4x7.rocketcdn.me/wp-content/uploads/2020/04/colonialismo-o-que-e-definicao-origem-colonias-e-caracteristicas.jpg',
    ...
    'democracia' => [
        ...
        'image' => 'https://s4.static.brasilescola.uol.com.br/be/conteudo/images/1-multidao-protestando.jpg',
    ...
    'cuneiforme' => [
        ...
        'image2' => 'https://www.infoescola.com/wp-content/uploads/2008/10/escrita-cuneiforme-450x302.jpg',
    ...
    'magistrados' => [
        'title' => 'Magistrados',
        'text' => 'Autoridades responsáveis por aplicar a lei e administrar a justiça, geralmente em um sistema judicial.',
        'image' => 'https://cj.estrategia.com/portal/wp-content/uploads/2023/10/06081423/juiz.jpeg',
        'source' => 'Fonte: Enciclopédia Juridica PUC-SP'
    ],
    'mumificação' => [
        'title' => 'Mumificação',
        'text' => 'Trata-se de um método de preservação de cadáveres que diminui drasticamente a intensidade da decomposição,  tradicional em civilizações antigas como a egípcia.',
        'image' => 'https://static.historiadomundo.com.br/2023/04/mumia-egito-antigo.jpg',
        'source' => 'Fonte: Brasil Escola'
    ],
    'primitivo' => [
        'title' => 'Primitivo',
        'text' => 'Que existiu primeiro entre os indivíduos de uma espécie. Relacionado às origens ou estágios iniciais de algo.',
        'image' => 'https://img.freepik.com/fotos-premium/elegante-com-lampada-brilhante-dentro-de-uma-cabeca-humana-de-alta-qualidade-de-alta-resolucao_1110519-20676.jpg?w=740',
        'source' => 'Fonte: Aulete Digital'
    ],
    'protestantismo' => [
        'title' => 'Protestantismo',
        'text' => 'É um conjunto de doutrinas religiosas cristã do século XVI, derivada da Reforma Protestante liderada pelo padre alemão Martinho Lutero. Caracterizado pela oposição a certas práticas da Igreja Católica.',
        'image' => 'https://jornalismocolaborativo.com/wp-content/uploads/2015/05/protestantismo.jpg',
        'source' => 'Fonte: Educa Mais Brasil'
    ],
    'racionalismo' => [
        'title' => 'Racionalismo',
    ...
    'religiosidade' => [
        'title' => 'Religiosidade',
        'text' => 'Sentimento ou prática do crente que pode estar relacionada com uma instituição religiosa, que expressa a devoção ou apego aos valores e crenças religiosas.',
        'image' => 'https://saberesepraticas.cenpec.org.br/wp-content/uploads/2020/04/religiao_banner.png',
        'source' => 'Fonte: Dialnet'
    ],
    'república' => [
        'title' => 'República',
        'text' => 'República é um regime de governo onde o Chefe de Estado e o Chefe de Governo são escolhidos através de eleições diretas ou indiretas. ',
        'image' => 'https://lh6.googleusercontent.com/proxy/_bpdmBznQ6kGHf8QKFfE-13O04vDute4lSDE2Dtts_1vqF2un53tVx-GYZxtGM7419CgTwl_tMPaaqSki9rcheAASdH4YsSBtSt-n2HXlPYJY1C7v2qoK55ID557Ng3SYA33LAZoguxQdyvauBNq_pzU63Q17VLHP3h-og',
